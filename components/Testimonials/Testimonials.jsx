        ...
        <section>
            <div className="max-w-[1400px] px-10 mx-auto py-20">
                ...
                <div className='flex justify-end mt-5 py-5 gap-x-3'>
                    <button className='custome-prev text-2xl text-zinc-800 hover:bg-gradient-to-b hover:from-orange-400 hover:to-orange-500 hover:text-white cursor-pointer rounded-lg w-11 h-11 justify-senter items-center bg-zinc-100'>
                        <IoIosArrowBack />
                    </button>
                    <button className='custome-next text-2xl text-zinc-800 hover:bg-gradient-to-b hover:from-orange-400 hover:to-orange-500 hover:text-white cursor-pointer rounded-lg w-11 h-11 justify-senter items-center bg-zinc-100'>
                        <IoIosArrowForward />
                    </button>
                </div>
