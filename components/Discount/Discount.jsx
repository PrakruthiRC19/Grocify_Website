...
const Discount = () => {
  return (
    <section className="bg-zinc-100 bg-no-repeat bg-right bg-contain" style={{backgroundImage:`url(${FreshFruits})`}}>
        <div className="md:bg-transparent bg-zinc-100 flex md:flex-row flex-col items-start max-w-[1400px] mx-auto px-10 py-10">
            <span className='md:text-9xl text-6xl text-orange-500 font-bold md:-rotate-90 h-fit md:mt-32'>20%</span>
